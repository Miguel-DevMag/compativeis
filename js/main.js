...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const knowledgeBase = [
    {
      ...
      response:
        "Olá! Como posso ajudar você hoje? Estou aqui para responder suas dúvidas sobre o Compatíveis.",
    },
    {
      keywords: [
        "o que é",
      ...
      response:
        "O Compatíveis é uma metodologia exclusiva de terapia de casal que já transformou mais de 145 relacionamentos. Usamos ciência comportamental para diagnosticar e resolver os padrões que estão sabotando sua relação.",
    },
    {
      keywords: ["márcio", "marcio", "terapeuta", "quem é", "quem e"],
      response:
        "Márcio é especialista em relacionamentos e formado em Análise Corporal. Ele tem mais de 3.960 horas de atendimento e já ajudou mais de 3.000 casais.",
    },
    {
      keywords: [
        "método",
      ...
      response:
        "A metodologia dos 3 Rs consiste em: 1) Reconhecer os problemas reais da relação, 2) Resolver os conflitos de maneira saudável com comunicação não-violenta, e 3) Reconectar emocionalmente, recuperando a admiração, carinho e intimidade que foram perdidos.",
    },
    {
      keywords: [
        "programa",
      ...
      response:
        "O programa completo oferece: 5 trilhas de transformação gravadas, 24 encontros ao vivo por ano com Márcio, e acesso a uma comunidade segura na plataforma Ciclo.",
    },
    {
      keywords: ["preço", "valor", "custo", "quanto custa", "investimento"],
      response:
        "O investimento para acessar a metodologia completa é de R$ 2.000, com garantia incondicional de 7 dias.",
    },
    {
      keywords: ["garantia", "devolução", "devolver"],
      response:
        "Oferecemos garantia incondicional de 7 dias. Se por qualquer motivo você não ficar satisfeito, pode solicitar o reembolso.",
    },
    {
      keywords: [
        "inscrever",
      ...
      response:
        'Para se inscrever, clique no botão "Aplicar Agora" ou "Garantir Minha Vaga" no site. Você será direcionado para o formulário de inscrição.',
    },
    {
      keywords: ["depoimentos", "relatos", "casos de sucesso", "histórias"],
      response:
        'Você pode ver relatos reais de casais que transformaram seus relacionamentos na seção "Relatos" do site. Há vídeos emocionantes de pessoas como Daniela & Jean, Aline, Thiago & Rafaela, e muitos outros!',
    },
    {
      keywords: [
        "contato",
      ...
      response:
        'Atualmente, você pode entrar em contato através do formulário de inscrição. Se precisar de algo mais específico, recomendo clicar no botão "Aplicar Agora" para iniciar o processo.',
    },
    {
      keywords: [
        "obrigado",
      ...
      response:
        "De nada! Fico feliz em ter ajudado. Se precisar de mais alguma coisa, é só perguntar!",
    },
  ];

  // Default response
  const defaultResponse =
    "Desculpe, não entendi exatamente sua pergunta. Você pode perguntar sobre o método, o Márcio, o programa, o preço ou os depoimentos!";
  ...
  function initGSAPAnimations() {
    ...
    heroTl.from(
      ".gsap-fade",
      { y: 20, opacity: 0, duration: 1.2, stagger: 0.15, ease: "power3.out" },
      0.5,
    );
    ...
    gsap.utils.toArray(".gsap-stagger").forEach((elem, i) => {
      gsap.from(elem, {
        scrollTrigger: {
          trigger: elem.closest(".bento-grid, .methodology-steps"),
          start: "top 80%",
        },
        y: 40,
        opacity: 0,
  ...
  gsap.utils.toArray("[data-counter]").forEach((el) => {
    ...
    gsap.to(
      { val: 0 },
      {
        ...
        onUpdate: function () {
          el.innerText =
            Math.round(this.targets()[0].val).toLocaleString("pt-BR") + suffix;
        },
      },
    );
  });
